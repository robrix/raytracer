...
intersectionsWithSphere (Ray o direction) (Sphere c r) = if discriminant < 0 then [] else atDistance <$> sort [ d1, d2 ]
  where d1 = negate dotted + sqrt discriminant
        ...
        atDistance d = Intersection (direction + o * fromScalar d) ((direction + o * fromScalar d) - c / fromScalar r)
